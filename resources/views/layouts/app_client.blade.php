...
<script src="{{ asset('asset/client/js/themessoft/revslider.js') }}"></script>
<script src="{{ asset('asset/client/js/themessoft/common.js') }}"></script>
<script src="{{ asset('asset/client/js/themessoft/owl.carousel.min.js') }}"></script>
<script src="{{ asset('asset/client/js/themessoft/jquery.mobile-menu.min.js') }}"></script>
<script src="{{ asset('asset/client/js/themessoft/countdown.js') }}"></script>
