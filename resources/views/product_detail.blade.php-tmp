          ...
          <div class="col-md-6">
            <div class="product-body">
              ...
              <div class="product-btns">
                ...
                <button class="primary-btn btnSubmitOrder add-to-cart btn-car " data-id="{{ $product->id }}" href="javascript::void(0)" type="button"><i class="fa fa-shopping-cart"></i>Mua hàng</button>
              </div>
              </form>
